...
This project automates the **end-to-end HR training data flow** from various sub-teams:
...
1. Development Mode: FLASK\_with\_ETL.py (Access at: http://127.0.0.1:8080)
2. Production Mode with Waitress : run\_waitress.py (Access at: http://ip-address:8080)
